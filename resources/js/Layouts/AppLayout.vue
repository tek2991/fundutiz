        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <JetNavLink :href="route('admin.sanctioner.index')" :active="route().current('admin.sanctioner.*')">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <div class="ml-3 relative">
                                <!-- Teams Dropdown -->
                                <JetDropdown v-if="$page.props.jetstream.hasTeamFeatures && $page.props.user.current_team" align="right" width="60">
                                    <template #trigger>
                                    ...
                                    <template #content>
                                        <div class="w-60">
                                            ...
                                            <template v-if="$page.props.jetstream.hasTeamFeatures && $page.props.user.current_team">
                                                ...
                                                <JetDropdownLink v-if="$page.props.jetstream.canCreateTeams && $page.props.is_admin" :href="route('teams.create')">
                                                    Create New Team
                                                </JetDropdownLink>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <JetResponsiveNavLink :href="route('admin.fund.index')" :active="route().current('admin.fund.*')">
                            Fund
                        </JetResponsiveNavLink>
                    </div>
                    <div class="pt-2 pb-3 space-y-1">
                        <JetResponsiveNavLink :href="route('admin.sanctioner.index')" :active="route().current('admin.sanctioner.*')">
                            Sanctioning Authorities
                        </JetResponsiveNavLink>
                    </div>
                    <div class="pt-2 pb-3 space-y-1">
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        ...
                        <div class="mt-3 space-y-1">
                            ...
                            <template v-if="$page.props.jetstream.hasTeamFeatures && $page.props.user.current_team">
                                ...
                                <JetResponsiveNavLink v-if="$page.props.jetstream.canCreateTeams  && $page.props.is_admin" :href="route('teams.create')" :active="route().current('teams.create')">
                                    Create New Team
                                </JetResponsiveNavLink>
