    ...
    <AppLayout title="Dashboard">
        <template #header>
            <span class="flex justify-between">
                ...
                <ButtonLink :href="route('admin.sanctioner.create')">Create</ButtonLink>
            </span>
        </template>
                                    ...
                                    <div
                                        ...
                                        <table
                                            ...
                                            <tbody
                                                ...
                                                <tr
                                                    v-for="item in sanctioners.data"
                                                    :key="item.id"
                                                    ...
                                                    <td
                                                        ...
                                                        <SimpleLink :href="route('admin.sanctioner.edit', item.id)">
                                                            Edit
                                                        </SimpleLink>
                                                    </td>
                                                </tr>
                                        ...
                                        <div v-if="sanctioners.meta.last_page > 1" class="py-6 px-6">
                                            <Pagination
                                                :pagination="sanctioners" />
                                        </div>
                                    </div>
                                </div>
                            </div>
